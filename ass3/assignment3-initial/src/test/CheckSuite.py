...
class CheckSuite(unittest.TestCase):
    ...
    def test_6_TypeMismatchInStatement(self):
        ...
        input = """
            ...
            func main() return
        """
        expect = "Type Mismatch In Statement: VarDecl(Id(a), ArrayType([1.0, 2.0], NumberType), None, ArrayLit(ArrayLit(NumLit(1.0), NumLit(2.0))))"
        ...
        input = """
            ...
            func main() return
        """
        expect = "Type Mismatch In Expression: For(Id(a), Id(b), Id(c), Return())"
    ...
    def test_6_TypeMismatchInExpression(self):
        ...
        """
        expect = "Type Cannot Be Inferred: VarDecl(Id(c), None, var, UnaryOp(-, Id(left)))"
        ...
        """
        expect = "Type Cannot Be Inferred: VarDecl(Id(c), None, var, ArrayCell(Id(a), [Id(b), NumLit(1.0)]))"
        ...
        """
        expect = "Type Cannot Be Inferred: AssignStmt(Id(c), ArrayLit(NumLit(1.0), NumLit(2.0)))"
...
return true
    ...
    def test_arraylit(self):
        ...
        """
        expect = "Type Mismatch In Statement: AssignStmt(Id(x), ArrayLit(NumLit(1.0), NumLit(2.0), NumLit(3.0)))"
        ...
        """
        expect = "Type Mismatch In Statement: VarDecl(Id(a), ArrayType([3.0], NumberType), None, ArrayLit(Id(x), NumLit(1.0), NumLit(2.0)))"
        self.assertTrue(TestChecker.test(input, expect, 502))     
        ...
        """
        expect = "Type Mismatch In Statement: VarDecl(Id(a), ArrayType([3.0], NumberType), None, ArrayLit(Id(x), NumLit(1.0), StringLit(1)))"
        self.assertTrue(TestChecker.test(input, expect, 502))  
        ...
        """
        expect = "Type Mismatch In Statement: VarDecl(Id(a), ArrayType([3.0], NumberType), None, ArrayLit(Id(x), ArrayLit(Id(x), Id(x)), NumLit(1.0)))"
        self.assertTrue(TestChecker.test(input, expect, 502))  
